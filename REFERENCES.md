...
These sources motivate the preregistered hypotheses and statistical safeguards.
Their inclusion is not evidence that an anomaly still exists in the EdgeStack
sample. Campaign verdicts come only from frozen, reproducible evidence.
...
- Lo, A. W., & MacKinlay, A. C. (1990). Data-snooping biases in tests of financial
  asset pricing models. *The Review of Financial Studies, 3*(3), 431–467.
  [doi:10.1093/rfs/3.3.431](https://doi.org/10.1093/rfs/3.3.431)
...
- Sullivan, R., Timmermann, A., & White, H. (1999). Data-snooping, technical trading
  rule performance, and the bootstrap. *The Journal of Finance, 54*(5), 1647–1691.
  [doi:10.1111/0022-1082.00163](https://doi.org/10.1111/0022-1082.00163)
...
## Cross-sectional return hypotheses
...
- Ang, A., Hodrick, R. J., Xing, Y., & Zhang, X. (2006). The cross-section of
  ...
  [doi:10.1111/j.1540-6261.2006.00836.x](https://doi.org/10.1111/j.1540-6261.2006.00836.x)
- George, T. J., & Hwang, C.-Y. (2004). The 52-week high and momentum investing.
  *The Journal of Finance, 59*(5), 2145–2176.
  [doi:10.1111/j.1540-6261.2004.00695.x](https://doi.org/10.1111/j.1540-6261.2004.00695.x)
...
- Lehmann, B. N. (1990). Fads, martingales, and market efficiency. *The Quarterly
  ...
  [doi:10.2307/2937816](https://doi.org/10.2307/2937816)

## Calendar and announcement hypotheses

- Ariel, R. A. (1987). A monthly effect in stock returns. *Journal of Financial
  Economics, 18*(1), 161–174.
  [doi:10.1016/0304-405X(87)90066-3](https://doi.org/10.1016/0304-405X%2887%2990066-3)
- French, K. R. (1980). Stock returns and the weekend effect. *Journal of Financial
  Economics, 8*(1), 55–69.
  [doi:10.1016/0304-405X(80)90021-5](https://doi.org/10.1016/0304-405X%2880%2990021-5)
...
- Lucca, D. O., & Moench, E. (2015). The pre-FOMC announcement drift. *The Journal
...
- `arch` multiple-comparison procedures: stationary bootstrap, Reality Check, and
  SPA. [Official documentation](https://bashtage.github.io/arch/multiple-comparison/index.html)
- Apache Arrow Parquet format.
  [Official specification](https://parquet.apache.org/docs/file-format/)
- DuckDB Parquet scanning.
  [Official documentation](https://duckdb.org/docs/stable/data/parquet/overview)
- pandas-market-calendars schedules and early closes.
